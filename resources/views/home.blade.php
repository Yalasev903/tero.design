...
document.addEventListener('DOMContentLoaded', function () {
    ...
    for (let i = 0; i < gridItemLinks.length; i++) {
        ...
        const svgArrowPrev = `
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="11" viewBox="0 0 5560.1 4209.61">
        ...
        const svgArrowNext = `
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="11" viewBox="0 0 1091.71 826.54">
